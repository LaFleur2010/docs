			...
			{	
				...
				while($x < $cont_cont)
				{
					if($_POST['nom_cont'][$x] != "" )
					{
						...
						$Sql_rep = "INSERT INTO tb_contacto_cli (id_cli, nom_cont, mail_cont, cargo_cont, fono_cont) VALUES('".$_POST['id_cli']."','".$_POST['nom_cont'][$x]."', '".$_POST['mail_cont'][$x]."', '".$_POST['cargo_cont'][$x]."', '".$_POST['fono_cont'][$x]."')";
						dbExecute($Sql_rep);
					}
				$x++;
				}
...
**********************************************************************************************************************************/
				echo"<input type='hidden' name='ingresa' id='ingresa' value='".$_POST['id_cli']."' />";		
...
if($_POST['modifica'] == "Modificar")
{
	...
	$SqlCont = "SELECT * FROM tb_contacto_cli WHERE id_cli = '".$_POST['id_cli']."' ";
	...
	if(dbExecute($sql))
	{
		...
		if($cont_cont > $tot_cxc)
		{
			...
			while($z < $cont_cont)
			{
				if($_POST['nom_cont'][$z] != "" )
				{
					...
					$Sql_cont_c = "INSERT INTO tb_contacto_cli (id_cli, nom_cont, mail_cont, cargo_cont, fono_cont) VALUES('".$_POST['id_cli']."','".$_POST['nom_cont'][$z]."', '".$_POST['mail_cont'][$z]."', '".$_POST['cargo_cont'][$z]."', '".$_POST['fono_cont'][$z]."')";
		...
		echo"<input type='hidden' name='modifica' id='modifica' value='$id_cli' />";
		echo "<script language='Javascript'>
