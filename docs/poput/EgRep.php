...
<title>Egreso de repuestos</title>
...
function ingresar()
{
	...
	var ods_rep		= document.f.ods_rep.value;
	...
	if(cant_rep != "")
	{
		if(ods_rep != "")
		{
			if(fe_rep != "")
			{
				...
				document.f.ods_rep.focus();
				return false ;
			}
		}else{
			alert("Debe Ingresar ods en la cual se utilizaron los repuestos a rebajar");
    ...
    <td width="809" height="30" align="center" valign="top"><table width="798" height="30" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="660" align="center"><table width="302" border="0" cellpadding="0" cellspacing="0" class="txt01">
            <tr>
              <td width="308" align="center"><span class="Estilo3">REBAJE/EGRESO DE REPUESTOS</span></td>
            </tr>
          </table></td>
        ...
        <td width="456" height="117" align="center" valign="middle">
          ...
          <table width="800" height="102" border="1" bordercolor="#FFFFFF" bgcolor="#cedee1">
            <tr>
              ...
              <table width="798" height="68" border="0" cellpadding="1" cellspacing="1" class="txtnormal">      
                  <tr>
                    <td height="18" align="left" class="txtnormaln">Cant</td>
                    <td height="18" align="left" class="txtnormaln">Ods</td>
                    <td height="18" align="left" class="txtnormaln">Fecha</td>
                    <td width="604" height="18" align="left" class="txtnormaln">NOTA/OBSERVACION</td>
                    </tr>
                  <tr>
                    <td width="60" height="24" align="left">
                    <input name="cant_rep" type="text" id="cant_rep" size="5" />                    </td>
                    <td width="60" align="left">
                    <input name="ods_rep" type="text" id="ods_rep" size="10" />                    </td>
                    <td width="61" align="left">
                    <input name="fe_rep" type="text" id="fe_rep" size="10" onkeyup="this.value=formateafecha(this.value)"  />                    </td>
                    <td align="left"><input name="nota_rep" type="text" id="nota_rep" size="80" /></td>
                    </tr>
                  <tr>
                    <td height="1" colspan="4" align="left"><label></label></td>
<? 
...
//***********************************************************************************************************************	
if($_POST['ingresa'] == "Guardar")
{
	$co=mysql_connect("$DNS","$USR","$PASS");
	mysql_select_db("$BDATOS", $co);
	
	$sqlc 	= "SELECT stock_rep FROM tb_repuestos WHERE cod_rep = '$cod_rep' ";
...
?>
                  ...
                  <tr>
                    ...
                    <input name="ingresa" type="submit" class="boton_ing" id="button3" value="Guardar" onclick="return ingresar()" <?php echo $estado_b; ?>/>
                    &nbsp;
