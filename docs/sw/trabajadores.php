...
<tr>
                  ...
                  <td width="1204" align="center" class="txtnormal3n"><label for="ficha"></label>
                    Telefono
                    <input type="text" name="telefono" id="telefono" /> 
                    Ficha: 
                    <input type="text" name="ficha" id="ficha" />
                    <input name="modifica" type="submit" class="boton_mod" id="button4" value="Modificar" <?php echo $est; ?>/></td>
    ...
    <tr>
      ...
      <td width="8%" class="txtnormal">FECHA INGRESO</td>
...
{
	$sql = "UPDATE softland.sw_personal SET telefono1 	= '".$_POST['telefono']."'
