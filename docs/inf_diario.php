                    ...
                    <table width="909" border="0" cellpadding="0" cellspacing="0" class="txtnormal7">
                      ...
                      <tr class="txtnormal">
                        ...
                        <td width="186" align="left" valign="middle"><span class="content"><span class="content Estilo8">
                          <?php 
									if($_POST['f1'] != "" and $_POST['fecha'] == ""){$fe_inf = $_POST['f1'];}
									if($_POST['fecha'] != ""){$fec = $_POST['fecha'];}
                   					$fe_inf	=	cambiarFecha($fe_inf, '-', '/' ); 
								?>
                          </span>
                          <input id="date_field" style="WIDTH: 7em" name="f1" value="<? echo $fe_inf; ?>" />
                        ...
                        <select name="combo1" class="combos" id="combo1" style="width: 180px;" >
                          <?php
						  		if($desc_ger == "" and $_POST['combo1'] != "")
								{
									$sql_ger 	  = "SELECT * FROM tb_gerencia WHERE cod_ger ='".$_POST['combo1']."' ";
									$resp_ger	  = mysql_query($sql_ger,$co);
									while($vrowsd = mysql_fetch_array($resp_ger))
									{
										$desc_ger 	= "".$vrowsd['desc_ger']."";
                        ...
                        <select name="combo2" class="combos" id="combo2" style="width: 180px;" >
                          <?php 
							  if($desc_dep == "" and $_POST['combo2'] != "")
								{
									$sql_dpto 	= "SELECT * FROM tb_dptos WHERE cod_dep ='".$_POST['combo2']."' ";
									$resp_dpto	= mysql_query($sql_dpto,$co);
									while($vrowsd=mysql_fetch_array($resp_dpto))
									{
										$desc_dep 	= "".$vrowsd['desc_dep']."";
						  		...
						  		echo"<option selected='selected' value='$cod_dep'>$desc_dep</option>"; 
						  ?>
                        </select>
                        
                        </td>
                        <td align="left" valign="middle">
                        <select name="combo3" class="combos" id="combo3" style="width: 180px;" onchange="evento()">
                          
                          <?php 
						  	if($area_t == "" and $_POST['combo3'] != "")
							{
								$sql_a 		= "SELECT * FROM tb_areas WHERE cod_ar = '".$_POST['combo3']."' ";
								$resp_a		= mysql_query($sql_a,$co);
						  	...
						  	echo"<option selected='selected' value='$cod_ar'>$area_t</option>"; 
						  ?>
                        </select>
...
?>
                        ...
                        <tr>
                          ...
                          <table width="896" border="0">
                            <tr>
                              <td width="888" height="21" align="left">
