...
body {
	margin-top: 100px;
	background-image: url(produccion2/imagenes/fondo.jpg);
}
-->
</style>
...
<table width="200" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#cedee1" background="produccion2/imagenes/login.jpg">
  <tr>
    <td align="center"><table width="430" height="247" border="0" align="center" cellpadding="0" cellspacing="0" class="txtnormaln">
      ...
      <tr>
        ...
        <legend class="txtnormaln">Validacion de usuario</legend>
		   ...
		   include ("produccion2/lg/lg_config.php");
		?>
                    <form action="../<?=$pag_ini_inter;?>" target="_top" method="post">
                      <tr>
