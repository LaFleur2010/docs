...
define('SECRET_SALT','9D1C7878715F980');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','diego.fuentes@softtimesa.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost'); 
define('DBNAME','soporte');
define('DBUSER','intrauser');
define('DBPASS','intranetmgyt');
