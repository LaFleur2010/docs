...
?>
<h1>Generar un nuevo Ticket</h1>
<p>Rellene el siguiente formulario para abrir un nuevo ticket.</p>
<form id="ticketForm" method="post" action="open.php" enctype="multipart/form-data">
  <?php csrf_token(); ?>
  <input type="hidden" name="a" value="open">
  <table width="800" cellpadding="1" cellspacing="0" border="0">
    <tr>
        <th class="required" width="160">Nombre Completo:</th>
        <td>
            <?php
            if($thisclient && $thisclient->isValid()) {
    ...
    <tr>
        <th class="required" width="160">Email:</th>
        <td>
            <?php
            if($thisclient && $thisclient->isValid()) { 
    ...
    <tr>
        <td class="required">Mensaje:</td>
        <td>
            <div><em>Por favor, proporcione tantos detalles como sea posible, así que lo mejor que podemos ayudar.</em> <font class="error">*&nbsp;<?php echo $errors['message']; ?></font></div>
