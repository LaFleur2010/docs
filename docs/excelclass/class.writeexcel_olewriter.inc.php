...
class writeexcel_olewriter {
    ...
    function _calculate_sizes() {
        ...
        if ($datasize % 1024 == 0) {
            $this->_big_blocks = $datasize/1024;
        } else {
            $this->_big_blocks = floor($datasize/1024)+1;
        }
...
/* ABR */
    ...
    function _write_pps($name, $type, $dir, $start, $size) {
        ...
        fputs($this->_filehandle, str_repeat($zero, (128-$length)));
        ...
        fputs($this->_filehandle, str_repeat($unknown1, 10));
